...
//***********************************************************************************************
      void Art2Ofsset(){
        ...
        motor1.setCurrentPosition(0);
        motor2.setCurrentPosition(0);
        //Serial.println("Cero 2 Encontrado");
      }
      ...
      void Art3Ofsset(){
        ...
        if(digitalRead(sensorPin) == 0 ){
          //Serial.println("Reversa Poquito");
          motor1.moveTo(5*steps_per_unit);
          while(motor1.currentPosition() != 5*steps_per_unit){
             motor1.setSpeed(10*steps_per_unit);
             motor1.runSpeedToPosition();
           }
        }
...
///Funcion para mover a un angulo a velocidad cte
      bool desplazar1 (float angulo){
        motor1.moveTo(angulo*steps_per_unit);
        while(motor1.currentPosition() != angulo*steps_per_unit){
          Serial.println("Desplazamiento de un Motor");
          motor1.setSpeed(10*steps_per_unit);
          motor1.runSpeedToPosition();
        }
        return 1;
      }
      bool desplazar2 (float angulo){
        motor1.moveTo(angulo*steps_per_unit);
        motor2.moveTo(angulo*steps_per_unit);
        while(motor1.currentPosition() != angulo*steps_per_unit || motor2.currentPosition() != angulo*steps_per_unit){
          motor1.setSpeed(10*steps_per_unit);
          motor2.setSpeed(10*steps_per_unit);
          motor1.runSpeedToPosition();
          motor2.runSpeedToPosition();
