...
void loop() {
  if (Serial.available() > 0) {
    ...
    Serial.println(q4);
 */
    /* articulacion1.moveTo(q1, 20);
    articulacion2.moveTo(q2, 20);
    articulacion3.moveTo(q3, 20);
    articulacion4.moveTo(q4, 20); */
        switch(motorTarget){
        case 1:
  ...
  if (firstCommaIndex != -1) { 
    ...
    if (secondCommaIndex != -1) {
      ...
      if (thirdCommaIndex != -1) {
        ...
        int variable1 = variable1String.toInt(); 
        int variable2 = variable2String.toInt(); 
        int variable3 = variable3String.toInt();
        int variable4 = variable4String.toInt();
        
        // Asigna las variables a tus variables de destino
        q1 = variable1;
        q2 = variable2;
        q3 = variable3;
        q4 = variable4;
